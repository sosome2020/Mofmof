...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { railway_name: @station.railway_name, station_name: @station.station_name, walking_minutes: @station.walking_minutes } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { railway_name: @station.railway_name, station_name: @station.station_name, walking_minutes: @station.walking_minutes } }
